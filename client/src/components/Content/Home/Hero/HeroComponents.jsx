            ...
            <div className="w-full h-fit lg:px-24">
                <div className="grid grid-cols-2 md:mt-8">
                    <div className="">
                        ...
                        <button className='px-4 py-2 bg-[#0ea5e9] hover:text-[#0ea5e9] hover:bg-white transition-all duration-300 rounded-full text-white font-extralight mt-4 hover:shadow-md'>Booking Now</button>
                    </div>
